...
- **규칙 2 (스누피/Etsy 메가히트 스타일 레이아웃)**: 마스터 썸네일은 박스 카드 테두리 없이 굵은 흰색 테두리(Die-cut) 텍스트 타이포그래피("20+ CUTE [SERIES] STICKER BUNDLE")와 둥근 리본 배너를 중앙에 배치하고, 주변에 대표 스티커 14개를 대형(980px)으로 중앙 빈 공간 없이 촘촘히 밀집 연출(캡처의 왼쪽 비바리움 팩 형태)해야 합니다.
