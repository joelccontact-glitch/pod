...
- **규칙 2 (스누피/Etsy 메가히트 20종 대형 920px 오버랩 밀집 레이아웃)**: 마스터 썸네일은 20개 스티커 전수를 대형(920px~990px) 스케일로 서로 200px 이상 촘촘히 포개어(Overlap) 배치하고 파스텔 톤 캔버스 배경과 데코 요소(✨💕)를 결합하여, 중앙 및 외곽 1px의 빈틈도 없이 캔버스 전체를 화려하게 꽉 채우는 Etsy 베스트셀러 스티커 팩 형태로 제작해야 합니다.
