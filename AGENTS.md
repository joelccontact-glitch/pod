...
- **규칙 2 (스누피/Etsy 메가히트 스타일 레이아웃)**: 마스터 썸네일은 20종을 작게 전부 늘어놓지 않고, 대표 10개 내외의 스티커를 큼직하게 중앙 엠블럼 주변에 밀집 배치(다이컷 흰색 테두리, 기울임 연출 등)하여 여백 없이 화면이 꽉 차는 스누피/Etsy 메가히트 디자인 스타일로 생성/조합해야 합니다.
