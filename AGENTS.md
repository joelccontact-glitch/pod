...
- **규칙 2 (스누피/Etsy 메가히트 20종 완전 밀집 레이아웃)**: 마스터 썸네일은 중앙 콤팩트 엠블럼 배지 주변 4면에 20개 스티커 전수를 5개 행(상단 5개, 중상단 4개, 중하단 4개, 하단 4개, 맨하단 3개)으로 촘촘히 좁혀 배치하여, 중앙 및 외곽 빈 공간 없이 화면 전체를 꽉 채우는 Etsy 베스트셀러 스티커 팩 형태로 제작해야 합니다.
